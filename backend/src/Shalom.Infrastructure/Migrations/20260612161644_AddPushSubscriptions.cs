    ...
    public partial class AddPushSubscriptions : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PushSendLogs", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Endpoint = table.Column<string>(type: "varchar(2000)", unicode: false, maxLength: 2000, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PushSendLogs_Kind_Date",
                table: "PushSendLogs",
