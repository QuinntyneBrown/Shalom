...
try
{
    ...
    builder.Host.UseSerilog((ctx, services, cfg) => cfg
        ...
        .WriteTo.Console()
        .WriteTo.File("logs/shalom-.log", rollingInterval: RollingInterval.Day));
    ...
    {
        o.SwaggerDoc("v1", new OpenApiInfo { Title = "Shalom API", Version = "v1" });
    });
...
/// <summary>
/// Bridges `JwtOptions` (configured in Shalom.Infrastructure DI) into
