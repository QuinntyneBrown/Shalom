...
namespace Shalom.Api.Tests.Auth;

public class AuthControllerTests : IClassFixture<ShalomApiFactory>
{
    private readonly ShalomApiFactory _factory;
    public AuthControllerTests(ShalomApiFactory factory) { _factory = factory; }
